...
insert into Match (TournamentID, Winner, WinnerPoints,
	Loser, LoserPoints, IsATie)
	values (1, 1, 2, 2, 0, False);
insert into Match (TournamentID, Winner, WinnerPoints,
	Loser, LoserPoints, IsATie)
	values (1, 3, 1, 4, 0, False);
insert into Match (TournamentID, Winner, WinnerPoints,
	Loser, LoserPoints, IsATie)
	values (1, 1, 3, 3, 2, False);
insert into Match (TournamentID, Winner, WinnerPoints,
	Loser, LoserPoints, IsATie)
	values (1, 2, 1, 4, 0, False);
insert into Match (TournamentID, Winner, WinnerPoints,
	Loser, LoserPoints, IsATie)
	values (1, 1, 3, 4, 1, False);
insert into Match (TournamentID, Winner, WinnerPoints,
	Loser, LoserPoints, IsATie)
	values (1, 2, 4, 3, 3, False);

-- report fencing matches
insert into Match (TournamentID, Winner, WinnerPoints,
	Loser, LoserPoints, IsATie)
	values (2, 5, 12, 6, 3, False);
insert into Match (TournamentID, Winner, WinnerPoints,
	Loser, LoserPoints, IsATie)
	values (2, 7, 9, 8, 4, False);
insert into Match (TournamentID, Winner, WinnerPoints,
	Loser, LoserPoints, IsATie)
	values (2, 5, 11, 7, 10, False);
insert into Match (TournamentID, Winner, WinnerPoints,
	Loser, LoserPoints, IsATie)
	values (2, 6, 8, 8, 2, False);
insert into Match (TournamentID, Winner, WinnerPoints,
	Loser, LoserPoints, IsATie)
	values (2, 5, 14, 8, 12, False);
insert into Match (TournamentID, Winner, WinnerPoints,
	Loser, LoserPoints, IsATie)
	values (2, 6, 11, 7, 7, False);
